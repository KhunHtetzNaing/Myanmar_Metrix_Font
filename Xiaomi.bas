...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Metrix.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Metrix.mtz")
	'	File.Copy(File.DirAssets,"Metrix.mtz",File.DirRootExternal & "/MIUI/theme","Metrix.mtz")
