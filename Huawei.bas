...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Metrix Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/HWThemes","Metrix.hwt") = True Then File.Delete(File.DirRootExternal,"Metrix.hwt")
	File.Copy(File.DirAssets,"Metrix.hwt",File.DirRootExternal & "/HWThemes","Metrix.hwt")
