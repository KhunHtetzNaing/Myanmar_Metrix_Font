...
public class samsung extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.samsung");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.samsung");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmmetrixfont.samsung", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmmetrixfont.vivo _vivo = null;
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"	Install ကိုနွိပ္ျပီး Myanmar Metrix(i";
mostCurrent._lb.setText((Object)("	Install ကိုနွိပ္ျပီး Myanmar Metrix(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Metrix(iFont) ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._tlb.setText((Object)("Samsung"));
 //BA.debugLineNum = 66;BA.debugLine="tlb.Color = Colors.rgb(63, 81, 181)";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="File.Copy(File.DirAssets,\"Metrix.apk\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Metrix.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Metrix.apk");
...
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Metrix.apk");
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 130;BA.debugLine="If File.Exists(File.DirRootExternal,\"Metrix.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Metrix.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 131;BA.debugLine="File.Delete(File.DirRootExternal,\"Metrix.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Metrix.apk");
 };
...
public static String  _b3_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="If File.Exists(File.DirRootExternal,\"Metrix.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Metrix.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 147;BA.debugLine="File.Delete(File.DirRootExternal,\"Metrix.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Metrix.apk");
 };
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 214;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautiful";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 192;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautif";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Metrix_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://bit.ly/2mqSEWy");
