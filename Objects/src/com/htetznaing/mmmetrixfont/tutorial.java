...
public class tutorial extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.tutorial");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.tutorial");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmmetrixfont.tutorial", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setText((Object)("Tutorial"));
 //BA.debugLineNum = 28;BA.debugLine="tlb.Color = Colors.rgb(63, 81, 181)";
