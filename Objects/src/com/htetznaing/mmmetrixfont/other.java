...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmmetrixfont.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setText((Object)("Other [#Root]"));
 //BA.debugLineNum = 112;BA.debugLine="tlb.Color = Colors.rgb(63, 81, 181)";
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 179;BA.debugLine="File.Copy(File.DirAssets,\"Metrix.ttf\",File.DirRo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Metrix.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
...
mostCurrent._lw = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Metr";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 638;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautiful";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 616;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautif";
