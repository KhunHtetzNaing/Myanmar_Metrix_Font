...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmmetrixfont.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.Initialize(mostCurrent.activityBA,"tlb");
 //BA.debugLineNum = 98;BA.debugLine="tlb.Text = \"Myanmar Metrix Font\"";
mostCurrent._tlb.setText((Object)("Myanmar Metrix Font"));
 //BA.debugLineNum = 99;BA.debugLine="tlb.Color = Colors.rgb(63, 81, 181)";
...
mostCurrent._b4 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Metr";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 285;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautiful";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 263;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautif";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Metrix_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Metrix+Font");
