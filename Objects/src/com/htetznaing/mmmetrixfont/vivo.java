package com.htetznaing.mmmetrixfont;
...
public class vivo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.vivo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmmetrixfont", "com.htetznaing.mmmetrixfont.vivo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmmetrixfont.vivo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmmetrixfont.slidemenu _sm = null;
...
public com.htetznaing.mmmetrixfont.main _main = null;
public com.htetznaing.mmmetrixfont.main2 _main2 = null;
public com.htetznaing.mmmetrixfont.samsung _samsung = null;
public com.htetznaing.mmmetrixfont.oppo _oppo = null;
public com.htetznaing.mmmetrixfont.huawei _huawei = null;
public com.htetznaing.mmmetrixfont.tutorial _tutorial = null;
public com.htetznaing.mmmetrixfont.about _about = null;
public com.htetznaing.mmmetrixfont.xiaomi _xiaomi = null;
public com.htetznaing.mmmetrixfont.other _other = null;
...
mostCurrent._lb.setText((Object)("	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Metrix.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar Metrix Font နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._tlb.setText((Object)("Vivo"));
 //BA.debugLineNum = 79;BA.debugLine="tlb.Color = Colors.rgb(63, 81, 181)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (63),(int) (81),(int) (181)));
...
mostCurrent._banner.Initialize2(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/4009730151",mostCurrent._banner.SIZE_SMART_BANNER);
...
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/5486463359");
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Metrix.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Vivo Myanmar Font/Metrix.txj");};
 //BA.debugLineNum = 136;BA.debugLine="File.Copy(File.DirAssets,\"Metrix.txj\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Metrix.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Metrix.txj");
...
mostCurrent._msg.setText((Object)("File Manager တစ္ခုခုထဲသို႔သြားၿပီး Vivo Myanmar Font ဖိုဒါထဲကိုဝင္ပါ။ Metrix.txj ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ သို႔မဟုတ္ Change Font2 နဲ႔ထပ္သြင္းၾကည့္ပါ။"));
...
mostCurrent._msg.setText((Object)("Install ကိုႏွိပ္ၿပီးတာနဲ႔ ဖုန္းမွာ Default File Manager တစ္ခုခုမေရြးထားရင္ေတာ့ ကိုယ့္ဘာသာကို ဖုန္းထဲက File Manager တစ္ခုခုထဲကိုသြားလိုက္ပါ။	ၿပီးရင္ Vivo Myanmar Font ဆိုတဲ့ဖိုဒါကိုရွာၿပီး ဝင္လိုက္ပါ။ အဲ့ဖိုဒါထဲမွာ Metrix.txj ဆိုတဲ့ဖိုင္ေလးကိုဖြင့္ၿပီး Apply ေပးလိုက္ပါ။ အဆင္မေျပတာမ်ားရွိရင္ Facebook က Myanmar Android Apps မွာလာေမးနိုင္ပါတယ္ :)"));
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Metrix.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Download/i Theme/Font/Metrix.txj");};
 //BA.debugLineNum = 162;BA.debugLine="File.Copy(File.DirAssets,\"Metrix.txj\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Metrix.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Metrix.txj");
...
mostCurrent._sm = new com.htetznaing.mmmetrixfont.slidemenu();
...
mostCurrent._lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Metr";
mostCurrent._mm = new anywheresoftware.b4a.keywords.constants.TypefaceWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Metr";
mostCurrent._mm.setObject((android.graphics.Typeface)(mostCurrent._mm.LoadFromAssets("Metrix.ttf")));
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 250;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Metrix_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Metrix+Font");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 228;BA.debugLine="copy.setText(\"#Myanmar_Metrix_Font App! Beautif";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Metrix_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Metrix+Font");
